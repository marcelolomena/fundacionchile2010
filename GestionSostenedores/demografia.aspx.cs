...
{
    public partial class demografia : System.Web.UI.Page
    {
        ...
        public static string GuardarDemografia(string qs, string codusu)
        {
            string respuesta = "[]";
            try
            {
                ...
                dim.GuardarDemografia(qsdecode, codusu);
            }
            catch (Exception e)
            {
        ...
        [WebMethod(EnableSession = true)]
        [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
        public static string ObtenerDemografia(string codusu)
        {
            string respuesta = "[]";
            try
            {
                datos.Dimensionamiento dim = new datos.Dimensionamiento();
                respuesta = dim.ObtenerDemografia(codusu);
            }
            catch (Exception e)
            {
                respuesta = "[{\"ERROR\":\"" + e.Message + "\"}]";
